...
extension CodeView {
    ...
    fileprivate func updateWebView(_ context: CodeView.Context) {
        updateWhatsNecessary(elementGetter: context.coordinator.getMimeType(_:), elementSetter: context.coordinator.setMimeType(_:), currentElementState: mode.mimeType)
        updateWhatsNecessary(elementGetter: context.coordinator.getContent(_:), elementSetter: context.coordinator.setContent(_:), currentElementState: code)
    ...
    func updateWhatsNecessary(elementGetter: (JavascriptCallback?) -> (),
                              elementSetter: @escaping (_ elementState: String) -> (),
